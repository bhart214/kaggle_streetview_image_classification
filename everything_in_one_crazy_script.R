...
train_files = list.files(path="C:/Users/bhart/Documents/R_Projects/streetview_image_classification_kaggle/trainResized/.", pattern=".Bmp",all.files=T, full.names=T, no.. = T) 
test_files = list.files(path="C:/Users/bhart/Documents/R_Projects/streetview_image_classification_kaggle/testResized/.", pattern=".Bmp",all.files=T, full.names=T, no.. = T)
...
# img1 = train_images[1]
# img1_red = img1[[1]][1:20, 1:20, 1]
# img1_green = img1[[1]][1:20, 1:20, 2]
...
#write_rds(tsneDF, path = "C:/Users/bhart/Dropbox/MSSP/Kaggle Streetview Image Classification/tsneDF.rds")
#write_rds(tsneDF, path = "C:/Users/bhart/Dropbox/MSSP/Kaggle Streetview Image Classification/tsneDF_2d.rds")
